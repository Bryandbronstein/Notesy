...
?>
    <form action="uploadEditedNote.php" method="POST">
        <h2 style="color: white;  font-size: 2.8rem;">Edit a Completed Note</h2>
        <div class="form">
            ...
            <div class="btnArea">
                ...
                <button style="width: 220px" type="submit" name="incomplete" class="completeBtn">&#9744; Mark as Incomplete</button>
            </div>
